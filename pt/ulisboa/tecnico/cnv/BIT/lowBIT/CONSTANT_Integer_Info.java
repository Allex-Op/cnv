...
package pt.ulisboa.tecnico.cnv.BIT.lowBIT;

import java.io.*;

public class CONSTANT_Integer_Info extends Cp_Info {
  // data member
  // bytes contains the value of the int constant
  public int bytes;
  
  // constructor
  public CONSTANT_Integer_Info(DataInputStream iStream, byte tag)
    throws IOException {
    this.tag = tag;
  ...
  public boolean equals(Object obj) {
    if (obj instanceof CONSTANT_Integer_Info)
      return (bytes == ((CONSTANT_Integer_Info) obj).bytes);
    return false;
  }
